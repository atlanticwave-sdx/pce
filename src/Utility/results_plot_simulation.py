...
def plot_simulation(path,title):
    ...
    y_label=["Compuation Time (s)", "Total Utility", "Max Utility",  "Mean Utility", "STD Utility", "90% Utility",  "Objective value"]
    ...
    for key in ninetypercetile_util_list_dict.keys():
        ax6.plot(num_connection_list,ninetypercetile_util_list_dict[key], label = str(key))
    plt.legend()
...
if __name__ == '__main__':
    ...
    #LastNlines(fname, N)
    path = '../../tests/results/'
    title= {'out_simulation_50_10_28/':"simulation.57510402_",
