...
class TEManagerTests(unittest.TestCase):
    ...
    def test_connection_amlight_to_zaoxi_with_vlans(self):
        ...
        self.assertIsInstance(zaoxi, dict)
        self.assertIsInstance(zaoxi.get("name"), str)
        self.assertIsInstance(zaoxi.get("dynamic_backup_path"), bool)
        self.assertIsInstance(zaoxi.get("uni_a"), dict)
        self.assertIsInstance(zaoxi.get("uni_a").get("tag"), dict)
        self.assertIsInstance(zaoxi.get("uni_a").get("tag").get("value"), int)
        self.assertIsInstance(zaoxi.get("uni_a").get("tag").get("tag_type"), int)
        self.assertIsInstance(zaoxi.get("uni_a").get("port_id"), str)
        self.assertIsInstance(zaoxi.get("uni_z"), dict)
        self.assertIsInstance(zaoxi.get("uni_z").get("tag"), dict)
        self.assertIsInstance(zaoxi.get("uni_z").get("tag").get("value"), int)
        self.assertIsInstance(zaoxi.get("uni_z").get("tag").get("tag_type"), int)
        self.assertIsInstance(zaoxi.get("uni_z").get("port_id"), str)


        self.assertIsInstance(sax, dict)
        self.assertIsInstance(sax.get("name"), str)
        self.assertIsInstance(sax.get("dynamic_backup_path"), bool)
        self.assertIsInstance(sax.get("uni_a"), dict)
        self.assertIsInstance(sax.get("uni_a").get("tag"), dict)
        self.assertIsInstance(sax.get("uni_a").get("tag").get("value"), int)
        ...
        self.assertIsInstance(sax.get("uni_z").get("tag").get("value"), int)
        self.assertIsInstance(sax.get("uni_z").get("tag").get("tag_type"), int)
        self.assertIsInstance(sax.get("uni_z").get("port_id"), str)

        self.assertIsInstance(amlight, dict)
        self.assertIsInstance(amlight.get("name"), str)
        self.assertIsInstance(amlight.get("dynamic_backup_path"), bool)
        self.assertIsInstance(amlight.get("uni_a"), dict)
        self.assertIsInstance(amlight.get("uni_a").get("tag"), dict)
        self.assertIsInstance(amlight.get("uni_a").get("tag").get("value"), int)
        self.assertIsInstance(amlight.get("uni_a").get("tag").get("tag_type"), int)
        self.assertIsInstance(amlight.get("uni_a").get("port_id"), str)
        self.assertIsInstance(amlight.get("uni_z"), dict)
        self.assertIsInstance(amlight.get("uni_z").get("tag"), dict)
        self.assertIsInstance(amlight.get("uni_z").get("tag").get("value"), int)
        self.assertIsInstance(amlight.get("uni_z").get("tag").get("tag_type"), int)
        self.assertIsInstance(amlight.get("uni_z").get("port_id"), str)
