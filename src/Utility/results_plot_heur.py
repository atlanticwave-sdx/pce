...
def plot_heur(path,title, tag):
    ...
    y_label=["Computation Time (s)", "Total Utility", "Max Utility",  "Mean Utility", "STD Utility", "90% Utility",  "Objective value"]
...
if __name__ == '__main__':
    ...
    title= {'out_heur_0_0_25_10_28_200/':"heur.58150822_",
